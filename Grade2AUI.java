...
public class Grade2AUI {

    public static void show(String userName, String userRole) {

        JFrame frame = new JFrame("Grade 2-A Students");
        ...
        JLabel title = new JLabel("GRADE 2-A STUDENTS");
        ...
        Object[][] data = {
            {"11", "Kyle Aquino", "2-A"},
            {"12", "Lyka Castro", "2-A"},
            {"13", "Matthew Bautista", "2-A"},
            {"14", "Nicole Fernandez", "2-A"},
            {"15", "Owen Velasco", "2-A"}
        };
