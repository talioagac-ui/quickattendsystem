...
public class Grade3BUI {

    public static void show(String userName, String userRole) {

        JFrame frame = new JFrame("Grade 3-B Students");
        ...
        JLabel title = new JLabel("GRADE 3-B STUDENTS");
        ...
        Object[][] data = {
            {"26", "Mateo Dela Cruz", "3-B"},
            {"27", "Luna Rosario", "3-B"},
            {"28", "Gabriel Ferrer", "3-B"},
            {"29", "Isabella Manalo", "3-B"},
            {"30", "Enzo Bautista", "3-B"}
        };
