...
public class Grade2BUI {

    public static void show(String userName, String userRole) {

        JFrame frame = new JFrame("Grade 2-B Students");
        ...
        JLabel title = new JLabel("GRADE 2-B STUDENTS");
        ...
        Object[][] data = {
            {"16", "Princess Pascual", "2-B"},
            {"17", "Quentin Salazar", "2-B"},
            {"18", "Rica Morales", "2-B"},
            {"19", "Steven Dimaano", "2-B"},
            {"20", "Trisha Manalo", "2-B"}
        };
                ...
                if (row != -1) {
                    if (userRole.equalsIgnoreCase("Student")) {
                        JOptionPane.showMessageDialog(frame,
                            ...
                            "Restricted Area", JOptionPane.ERROR_MESSAGE);
                    ...
                    JOptionPane.showMessageDialog(null, "Opening record for: " + studentName + " (" + studentId + ")");
                }
            }
        });
    ...
    static JButton createBtn(String text, boolean isActive,
        ...
        btn.addActionListener(e -> {
            ...
            switch (text) {
                ...
                case "TEACHERS": TeacherDepartmentsUI.show(userName, userRole); break;
