...
public class Grade3AUI {

    public static void show(String userName, String userRole) {

        JFrame frame = new JFrame("Grade 3-A Students");
        ...
        JLabel title = new JLabel("GRADE 3-A STUDENTS");
        ...
        Object[][] data = {
            {"21", "Ulysses Pineda", "3-A"},
            {"22", "Vanessa Alvarez", "3-A"},
            {"23", "William Medina", "3-A"},
            {"24", "Xyra Domingo", "3-A"},
            {"25", "Yuri Cortez", "3-A"}
        };
